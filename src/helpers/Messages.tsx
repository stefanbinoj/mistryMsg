export const messages = [
    ...
    { 
      quote: "Whoa, you've ventured into a realm that even we don’t fully understand. Are you looking for hidden treasure, or just really good at getting lost? Either way, the adventure continues!", 
