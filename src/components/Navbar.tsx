  ...
  return (
    <nav className={`pl-5 pr-0 py-5 mx-2 z-50 shadow-lg sticky top-0 backdrop-blur-sm border-b  ${isDarkMode ? 'bg-black/30 text-white border-gray-800' : 'bg-white text-black border-gray-300'}`}>
        ...
        md:flex flex-row gap-4 items-center ml-5 w-screen justify-between '>
            <a className={`font-bold text-xl ml-4 ${!isDarkMode?'bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 text-transparent bg-clip-text':'bg-gradient-to-r from-orange-400 to-red-400 text-transparent bg-clip-text'} hover:scale-125 transition-all duration-300 ease-in-out`} href='/'>Mystery Message</a>
